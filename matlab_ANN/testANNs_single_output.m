...
[input_ori, output_ori,predict_stations] = load_data(input_var,test_mode,fullfile(DATA_DIR,FILE_NAME),predict_stations);
...
[output_ANN_predictions,nets] = predict(predict_stations,input_scaled);
...
test_location = strrep(strrep(strjoin(predict_stations,'_'),' ','_'),'__','_');

write2txt(output_ANN_predictions,predict_stations,save_precision,...
